...
const SubCategoryDirectorInbox: React.FC = () => {
  ...
  // Sub-category director specific state
  ...
  // Sub-category director inbox buttons
  const inboxButtons = [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="text-sm text-purple-600 mt-2">
            Sub-Category Director Inbox - Department-level management
          </p>
          <p className="text-xs text-gray-500 mt-1">
            Managing: {user.departmentOrSector || "Department"}
          </p>
        </div>
...
export default SubCategoryDirectorInbox;
