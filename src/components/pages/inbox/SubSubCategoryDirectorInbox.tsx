...
const SubSubCategoryDirectorInbox: React.FC = () => {
  ...
  // Sub-sub-category director specific state
  ...
  // Sub-sub-category director inbox buttons
  const inboxButtons = [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="text-sm text-green-600 mt-2">
            Sub-Sub-Category Director Inbox - Unit-level management
          </p>
          <p className="text-xs text-gray-500 mt-1">
            Managing: {user.departmentOrSector || "Unit"}
          </p>
        </div>
...
export default SubSubCategoryDirectorInbox;
